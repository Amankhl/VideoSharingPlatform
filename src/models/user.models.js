...
7) Server Verification: When the server receives a request with the token, it verifies the token’s authenticity and validity. This involves decoding the token using
